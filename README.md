...
* These packages have been remarkably useful: [*nibabel*](https://pypi.org/project/nibabel/) (for reading NIFTI files), *pydicom* (for dealing with Dicom files), *segmentation-models-3D* (for Loss functions and segmentation metrics), *focal_loss* (for direct usage of Focal loss function).
