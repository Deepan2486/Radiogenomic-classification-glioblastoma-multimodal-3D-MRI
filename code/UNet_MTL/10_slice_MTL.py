...
train_images_list=sorted(glob.glob('/content/drive/MyDrive/Colab Notebooks/data/10_slices_patient/flair/train/*'))
train_masks_list=sorted(glob.glob('/content/drive/MyDrive/Colab Notebooks/data/10_slices_patient/mask/train/*'))
test_images_list=sorted(glob.glob('/content/drive/MyDrive/Colab Notebooks/data/10_slices_patient/flair/test/*'))
test_masks_list=sorted(glob.glob('/content/drive/MyDrive/Colab Notebooks/data/10_slices_patient/mask/test/*'))
class_labels=pd.read_csv('/content/drive/MyDrive/Colab Notebooks/data/patient_10_slice_labels.csv', index_col=0)
...
train_images=np.load('/content/drive/MyDrive/Colab Notebooks/data/10_slices_patient/flair/train_images.npy')
test_images=np.load('/content/drive/MyDrive/Colab Notebooks/data/10_slices_patient/flair/test_images.npy')
train_masks=np.load('/content/drive/MyDrive/Colab Notebooks/data/10_slices_patient/mask/train_masks_2_class_categorical.npy')
test_masks=np.load('/content/drive/MyDrive/Colab Notebooks/data/10_slices_patient/mask/test_masks_2_class_categorical.npy')
...
np.save('/content/drive/MyDrive/Colab Notebooks/data/10_slices_patient/mask/train_masks_2_class_categorical.npy', train_masks)
...
np.save('/content/drive/MyDrive/Colab Notebooks/data/10_slices_patient/mask/test_masks_2_class_categorical.npy', test_masks)
...
train_labels=class_labels[0:4710]
test_labels=class_labels[4710:]
...
plt.imshow(train_images[800,:,:,0], cmap='gray')
plt.imshow(train_masks[800,:,:,1], cmap='gray')
...
model.save('/content/drive/MyDrive/Colab Notebooks/data/saved_models/MTL_10_slices_0.7seg_50epochs.hdf5')
...
IOU_keras.update_state(test_masks[:,:,:,1], y_pred_argmax)
