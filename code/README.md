...
* Packages (as mentioned here) should be installed beforehand, before importing them into the .py files. The main dataset is the [BraTs dataset](Radiogenomic-classification-glioblastoma-multimodal-3D-MRI/data/BraTS_2021).
